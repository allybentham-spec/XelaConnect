...
echo "Creating main app views..."

# MainTabView
cat > /app/ios/XelaConnect/Views/Main/MainTabView.swift << 'SWIFT'
//
//  MainTabView.swift
//  XelaConnect
//
...
echo "✅ Created MainTabView.swift"

# DashboardView
cat > /app/ios/XelaConnect/Views/Main/DashboardView.swift << 'SWIFT'
//
//  DashboardView.swift
//  XelaConnect
//
...
echo "✅ Created DashboardView.swift"

# Placeholder views
for view in Community Discover Messages; do
    cat > /app/ios/XelaConnect/Views/Main/${view}View.swift << SWIFT
//
//  ${view}View.swift
//  XelaConnect
//
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                VStack(spacing: 20) {
                    Image(systemName: "${view,,}" == "community" ? "person.3" : "${view,,}" == "discover" ? "sparkles" : "message")
                        .font(.system(size: 64))
...
SWIFT
    echo "✅ Created ${view}View.swift"
done

echo "✅ All main view files created!"
